...
pub enum AccountSource {
    ...
    #[cfg(feature = "zip-48")]
    Zip48 { key_source: Option<String> },
}
...
impl AccountSource {
    ...
    pub fn key_source(&self) -> Option<&str> {
        match self {
            ...
            #[cfg(feature = "zip-48")]
            AccountSource::Zip48 { key_source, .. } => key_source.as_ref().map(|s| s.as_str()),
        }
    }
}
...
pub trait Account {
    ...
    fn purpose(&self) -> AccountPurpose {
        match self.source() {
            ...
            #[cfg(feature = "zip-48")]
            // ViewOnly for now, until spend capability is implemented
    ...
    /// Returns the ZIP 48 full viewing key for the account, if this is a ZIP 48
    /// transparent multisig account.
    #[cfg(feature = "zip-48")]
    fn zip48_fvk(&self) -> Option<&transparent::zip48::FullViewingKey> {
        todo!("This method goes aways with ZIP 316 Revision 0.1")
    }
}
...
pub trait WalletWrite: WalletRead {
    ...
    /// at the next available index for the specified scope.
    ///
    /// # Parameters
