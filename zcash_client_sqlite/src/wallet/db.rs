...
/// - `zip48_fvk`: For ZIP 48 transparent multisig accounts (account_kind = 2), the serialized
///   ZIP 48 full viewing key. This contains the threshold and all information needed for address
///   derivation. Must be null for non-multisig accounts.
