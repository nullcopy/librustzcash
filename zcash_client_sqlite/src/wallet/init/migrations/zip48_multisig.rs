...
//! - Updates the `accounts` CHECK constraint to allow `account_kind = 2` (transparent multisig)
...
pub(super) const MIGRATION_ID: Uuid = Uuid::from_u128(0x8a7b6c5d_4e3f_2a1b_9c8d_7e6f5a4b3c2d);
...
impl RusqliteMigration for Migration {
    ...
    fn up(&self, transaction: &rusqlite::Transaction) -> Result<(), Self::Error> {
        ...
        // to allow account_kind = 2 for transparent multisig accounts.
        //
